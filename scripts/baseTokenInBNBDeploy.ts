...
import * as contractData from '../artifacts/contracts/BaseTokenInBNB.sol/BaseTokenInBNB.json';
...
async function deployContract() {
    ...
    const web3 = new Web3(process.env.TEST_BNB_RPC_ADDRESS);
    ...
    deploy.send({
      ...
      .on('receipt', (receipt) => {
        ...
        appendFileSync('deployment-base-token-info.txt', dataToWrite);
